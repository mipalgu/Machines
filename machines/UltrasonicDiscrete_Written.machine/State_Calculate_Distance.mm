...
Calculate_Distance::Calculate_Distance(const char *name): CLState(name, *new Calculate_Distance::OnExit, *new Calculate_Distance::OnEntry, *new Calculate_Distance::Internal)
{
